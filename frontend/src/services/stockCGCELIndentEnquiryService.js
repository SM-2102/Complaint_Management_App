 ...
 * @returns {Promise<Array>} List of warranty enquiry records
 */
async function stockCGCELIndentEnquiry(params = {}, limit = 100, offset = 0) {
  ...
  const query = Object.entries(params)
    ...
    .join("&");
  const url = query
    ? `${API_ENDPOINTS.STOCK_CGCEL_INDENT_ENQUIRY}?${query}`
    : API_ENDPOINTS.STOCK_CGCEL_INDENT_ENQUIRY;
...
export { stockCGCELIndentEnquiry };
