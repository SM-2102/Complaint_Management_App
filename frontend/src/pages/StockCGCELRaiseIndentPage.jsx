...
const StockCGCELRaiseIndentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createCGCELIndent(form.spare_code, payload);
      setError({
          ...
          <div className="flex items-center w-full gap-3">
            <div className="flex items-center w-2/5 gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`flex-1 w-full px-3 py-1 rounded-lg border ${errs_label.indent_qty ? "border-red-300" : "border-gray-300"} bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400 font-small`}
                required
                disabled={submitting}
              />
            </div>
            <div className="flex items-center w-3/5 gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`flex-1 w-full px-3 py-1 rounded-lg border ${errs_label.order_number ? "border-red-300" : "border-gray-300"} bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400 font-small`}
                required
                disabled={submitting}
              />
            </div>
          ...
          <div className="flex items-center w-full gap-5">
            <div className="flex items-center w-2/5 gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`flex-1 w-full px-3 py-1 rounded-lg border ${errs_label.order_date ? "border-red-300" : "border-gray-300"} bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400 font-small`}
                required
                disabled={submitting}
            ...
            <div className="flex items-center w-3/5 gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`flex-1 w-full px-3 py-1 rounded-lg border ${errs_label.party_name ? "border-red-300" : "border-gray-300"} bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400 font-small`}
                required
                maxLength={30}
                disabled={submitting}
              />
...
export default StockCGCELRaiseIndentPage;
