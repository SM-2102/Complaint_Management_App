...
import { UploadGRCCGPISL } from "../services/grcCGPISLUploadService";

const GRCCGPISLUploadPage = () => {
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      const res = await UploadGRCCGPISL(file);
      setError({
        message: res.message,
...
export default GRCCGPISLUploadPage;
