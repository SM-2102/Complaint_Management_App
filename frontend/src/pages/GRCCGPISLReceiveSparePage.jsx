...
import { fetchNotReceivedGRCNumbers } from "../services/grcCGPISLNotRceievedGRCNumberService";
import { fetchNotReceivedGRCDetails } from "../services/grcCGPISLNotReceivedDetailsService";
import { receiveGRCSpare } from "../services/grcCGPISLNotReceivedUpdateService";
...
const GRCCGPISLReceiveSparePage = () => {
  ...
  const fetchStockByDivision = async (division) => {
    ...
    try {
      const res = await stockCGPISLListByDivision(division);
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="ml-2 p-0 rounded-full bg-gradient-to-tr from-green-200 to-green-500 text-white shadow-md hover:scale-105 hover:from-green-600 hover:to-green-900 focus:outline-none transition-all duration-200 flex items-center justify-center"
...
export default GRCCGPISLReceiveSparePage;
