...
import { updateCGPISLReturnSave } from "../services/grcCGPISLReturnSaveService";
import { fetchNextCGPISLGRCChallanCode } from "../services/grcCGPISLNextChallanCodeService";
import { grcCGPISLListByDivision } from "../services/grcCGPISLReturnListByDivisionService";
import { printGRCReturn } from "../services/grcCGPISLReturnPrintService";
import { updateCGPISLReturnFinalize } from "../services/grcCGPISLReturnFinalizeService";
  ...
  return (
    <input
      ...
      style={{
        width: 70,
        textAlign: "center",
        border: hasError ? "1px solid #fca5a5" : "1px solid #81c784",
        borderRadius: 6,
        padding: "4px 6px",
...
const Row = React.memo(function Row({
  ...
  return (
    <TableRow
      ...
      sx={{
        background: rowIndex % 2 === 0 ? "#f1f8f4" : "#fff",
        height: 38,
      }}
    >
      {columns.map((col) => (
...
const GRCCGPISLReturnSparePage = () => {
  ...
  const handleExecuteAction = async (e) => {
    ...
    try {
      if (form.action_type === "Save as Draft") {
        ...
        await updateCGPISLReturnSave(payload);
        setShowToast(true);
        ...
        await updateCGPISLReturnFinalize(payload);
        setShowToast(true);
  ...
  useEffect(() => {
    ...
    setLoading(true);
    grcCGPISLListByDivision(form.division)
      .then((result) => {
        if (mounted) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-1 ml-10 mr-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                required
                className="w-full mr-40 px-2 py-1 rounded-lg border border-gray-300 text-gray-900 font-small focus:outline-none focus:ring-2 focus:ring-green-400"
                style={{ minWidth: 140 }}
              >
            ...
            <div className="flex items-center gap-2">
              <label
                ...
                className="text-md  ml-20 font-medium text-green-800 min-w-[110px]"
              >
                Challan Code
              </label>
              <input
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className={`w-full px-2 py-1 rounded-lg border ${errs_label.sent_through ? "border-red-300" : "border-gray-300"} font-small focus:outline-none focus:ring-2 focus:ring-green-400 `}
                style={{ minWidth: 140 }}
                autoComplete="off"
                maxLength={20}
              />
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className={`w-full mr-40 px-2 py-1 rounded-lg border border-gray-300 font-small focus:outline-none focus:ring-2 focus:ring-green-400 ${!isReportTypeEnabled ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "text-gray-900"}`}
                style={{ minWidth: 140 }}
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="w-full px-2 py-1 mr-20 rounded-lg border border-gray-300 text-gray-900 font-small focus:outline-none focus:ring-2 focus:ring-green-400"
                style={{ minWidth: 140 }}
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className={`w-full px-2 py-1 rounded-lg border ${errs_label.docket_number ? "border-red-300" : "border-gray-300"} font-small focus:outline-none focus:ring-2 focus:ring-green-400 `}
                style={{ minWidth: 140 }}
                autoComplete="off"
                maxLength={8}
              />
...
export default GRCCGPISLReturnSparePage;
