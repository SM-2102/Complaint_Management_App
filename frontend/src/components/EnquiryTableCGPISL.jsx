...
const EnquiryTableCGPISL = ({
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`<style>
      ...
      .print-title{font-size:2rem;font-weight:800;text-align:center;color:#2e7d32;margin-bottom:18px;letter-spacing:1px;}
        ...
        >
          <div
            style={{
              ...
              padding: 32,
              minWidth: 400,
              boxShadow: "0 4px 24px rgba(46,125,50,0.18)",
              maxHeight: "80vh",
              overflowY: "auto",
            }}
          >
            ...
            >
              <span style={{ fontWeight: 700, fontSize: 20, color: "#2e7d32" }}>
                Export Data
              </span>
              <button
