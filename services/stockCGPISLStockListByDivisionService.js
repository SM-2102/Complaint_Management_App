 ...
 */
async function stockCGPISLListByDivision(division) {
  if (!division) throw new Error("Division is required");
  const url = `${API_ENDPOINTS.STOCK_CGPISL_LIST_BY_DIVISION}/${encodeURIComponent(division)}`;
...
export { stockCGPISLListByDivision };
