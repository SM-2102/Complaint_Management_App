...
class GRCCGPISLSchema(BaseModel):
...
class GRCCGPISLReceiveSchema(BaseModel):
    spare_code: str
...
class GRCCGPISLUpdateReceiveSchema(BaseModel):
    spare_code: str
    grc_number: int
    receive_qty: Optional[int]
    damaged_qty: Optional[int]
...
class GRCCGPISLDisputeCreate(BaseModel):
    spare_code: str
    division: str
    grc_number: int
    grc_date: date
...
class GRCCGPISLReturnSchema(BaseModel):
    grc_number: int
    grc_date: str
    spare_code: str
    spare_description: str
...
class GRCCGPISLReturnSave(BaseModel):
    spare_code: str
    grc_number: int
    good_qty: Optional[int]
    defective_qty: Optional[int]
...
class GRCCGPISLFinalizeRow(BaseModel):
    spare_code: str
    grc_number: int
    good_qty: Optional[int]
    defective_qty: Optional[int]
...
class GRCCGPISLReturnFinalizePayload(BaseModel):
    challan_number: str
    division: str
    sent_through: Optional[str]
    docket_number: Optional[str]
...
class GRCCGPISLHistorySchema(BaseModel):
    division: str
    spare_code: str
    spare_description: str
    grc_number: int
...
class GRCCGPISLEnquiry(BaseModel):
    spare_code: str
    spare_description: str
    grc_number: int
    grc_date: str
