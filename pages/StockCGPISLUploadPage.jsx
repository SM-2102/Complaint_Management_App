...
import { UploadStockCGPISL } from "../services/stockCGPISLUploadService";

const StockCGPISLUploadPage = () => {
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      const res = await UploadStockCGPISL(file);
      setError({
        message: res.message,
...
export default StockCGPISLUploadPage;
